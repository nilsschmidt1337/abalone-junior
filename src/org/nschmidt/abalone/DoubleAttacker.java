...
public enum DoubleAttacker {
    ...
    public static long[] performDoubleAttack(long state, Player player) {
    ...
    private static int tryDoubleAttack(long state, Player player, Player opponent, int from, int dir, int moveCount, int[] neighbourIndicies, long[] tempResult) {
