...
public enum DoubleAttacker {
    ...
    public static long[] performDoubleAttack(long state, long player) {
    ...
    private static int tryDoubleAttack(long state, long player, long opponent, int from, int dir, int moveCount, int[] neighbourIndicies, long[] tempResult) {
