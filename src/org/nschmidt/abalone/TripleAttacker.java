...
public enum TripleAttacker {
    ...
    public static BigInteger[] performTripleAttack(BigInteger state, Player player) {
    ...
    private static int tryTripleAttack(BigInteger state, Player player, Player opponent, int from, int dir, int moveCount, int[] neighbourIndicies, BigInteger[] tempResult) {
